...
def animate_intensity(i):
    ...
    ax2.scatter(sort_ex, sort_ey, c=aduToeV(sort_ep,m,b), s=25, cmap=cm.jet)
    ax2.set_title('Event Intensity (eV)')
    ...
    if int(show_images) != 1:
        ...
        ax3.set_xlabel('Pulse Height (ADU)')
        ax3.set_ylabel('Event/Bin')
...
ani = animation.FuncAnimation(fig, animate_intensity, interval=300)
plt.show()
